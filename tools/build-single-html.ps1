...
$include = @(
  ...
  "docs/D9_Runnable_Prototype_v1.md",
  ...
  "pyproject.toml",
  "src/sap_finsight_integration/config.py",
  "src/sap_finsight_integration/extract.py",
  "src/sap_finsight_integration/transform.py",
  "src/sap_finsight_integration/load.py",
  "src/sap_finsight_integration/reconcile.py",
  "src/sap_finsight_integration/pipeline.py",
  "src/sap_finsight_integration/cli.py",
